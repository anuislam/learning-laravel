...
class tags extends TarmModel
{
    ...
    public function tarm_form_output($errors){
		echo Form::open(['url' => route('stor-tarms', 'tags'), 'method' => 'POST']); 
			...
			do_action('post_tags_meta', $errors);
    ...
    public function tarm_data_process($request, $tarm_type){
    	...
    	do_action('post_tags_meta_validation', $request->all());
    ...
    public function tarm_data_save($data, $tarm_type){
    	...
    	if ($id) {
    		do_action('post_tags_meta_save', $data);
    ...
    public function tarm_edit_form_output($value = '', $errors) {
		...
		echo Form::open(['url' => route('edit-tarm-update', [$value['id'], 'tags']), 'method' => 'PATCH']);
			...
			do_action('post_tags_meta_edit', $errors);
    ...
    public function tarm_edit_data_process($request, $tarm_id ) {
    	...
    	do_action('post_tags_meta_edit_validation', $request->all());
    ...
    public function tarm_edit_data_update($data, $tarm_id){
        ...
        do_action('post_tags_meta_edit_update', $tarm_id);
