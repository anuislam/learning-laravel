        ...
        <div class="container">
            <div class="row">
                <div class="companyinfo">
                    <a href="index.html">
                        <img src="{{ Module::asset('allstor:img/logo-b.png') }}" alt="AllStore - MultiConcept eCommerce Responsive HTML5 Template">
                ...
                <div class="stylization f-block-modal f-block-modal-map" id="f-block-modal-4">
                    <div class="allstore-gmap">
                        <div class="marker" data-zoom="15" data-lat="-37.81485261872975" data-lng="144.95655298233032" data-marker="{{ Module::asset('allstor:img/marker.png') }}">534-540 Little Bourke St, Melbourne VIC 3000, Australia</div>
                    </div>
                </div>
                <div class="f-delivery">
                    <img src="{{ Module::asset('allstor:img/map.png') }}" alt="">
