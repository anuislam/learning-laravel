...
<div class="tab-content" id="uploder-nav-tabContent">
  ...
  <div class="tab-pane" id="nav-home" role="tabpanel">
    ...
    <div 
        ...
        data-upload-options='{"action":"<?php echo e(route("media.store")); ?>"}'
    ></div>
        ...
        <div class="col-md-4 my-2" id="uploader_info">
          <span class="uploader_info_main uploader_slimScroll">
            ...
            <div class="form-group text-center my-2" id="uploader_info_image">
              ...
              <span>
                <?php echo e(HTML::image(upload_dir_url('default/largefileicon.png'), 'picture', array('class' => 'img-thumbnail'))); ?>

              </span>
            </div>          

            <?php echo Form::open(['url' => route('update-uploder'), 'method' => 'put', 'id' => 'media_uploader_form']); ?> 
              <?php echo Form::hidden( 'uploader_media_id', '', ['id' => 'uploader_media_id'] );; ?>
